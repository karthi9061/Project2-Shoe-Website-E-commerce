...
import WomenShoesPage from '../subPage/WomenShoesPage.jsx';
...
const Women = () => {
  ...
  return (
    <div className="w-full h-screen flex flex-col md:flex-row">
      <div className="w-full md:w-1/6 h-auto md:h-screen sticky top-0 bg-gray-100 p-4">
        <div className="text-4xl font-freckle text-indigo-600 mb-8 flex items-center justify-center">
          Women's Collection
        </div>
        <Filter onFilter={handleFilter} />
      </div>
      <div className="flex-grow overflow-y-auto h-auto md:h-screen p-4 bg-white">
